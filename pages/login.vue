  ...
  <div class="flex relative  h-screen w-screen">
    <div class="flex relative justify-center text-left flex-col py-8 px-12 gap-4 sm:w-2/3 text-white lg:w-1/3 -translate-y-20">
      ...
      <div class="flex flex-col gap-1">
        <b class="text-xl">Log in to your account</b>
        <span class="lg:text-md text-sm opacity-70">Don't have account? <nuxt-link to="/register" class="font-bold underline text-[#D8B4FE]">Sign up</nuxt-link> for one.</span>
      </div>
      <!--     inputs -->
      <form @submit.prevent="submit">
        ...
        <!--     sign up btn-->
        <button class="mt-8 bg-[#a78bfa] w-full px-4 py-2 font-bold rounded-xl">Log in</button>
      </form>
      <!--     sign up btn-->
